...
if __name__ == "__main__":
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('loss_plot_albert.png')
    print("\n[Plot] Training and validation loss saved to loss_plot_albert.png")
    plt.close()
    ...
    plt.savefig('test_accuracy_plot_albert.png')
    print("[Plot] Test accuracy saved to test_accuracy_plot_albert.png")
    plt.close()
