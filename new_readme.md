...
| **LoRA Configuration** | Rank=6, Alpha=24, Target: query/key/value/dense |
...
```
- Must learn word meanings, syntax, context, AND negotiation codes
- All 20.6M parameters start from random initialization
- Requires large dataset to learn basic language patterns
...
```
- Already understands word meanings, syntax, and context from 160GB pretraining
- Only 1.9M parameters need updating (via LoRA)
- Can focus solely on learning negotiation-specific patterns

**Concrete Impact:**
- **Custom GPT**: Must learn "what does 'offer' mean?" AND "is this an offer statement?"
- **BERT**: Already knows "what does 'offer' mean?" → only learns "is this an offer statement?"

This is why BERT achieved 56% accuracy with 1,300 samples, while GPT struggled to learn basic language patterns and achieved only 44% accuracy.
